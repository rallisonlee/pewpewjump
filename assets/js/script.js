$(document).ready(function() {
	...
	function gameStart() {
		...
		function collisionCheck(rect1, rect2, collisionDetected) {
			if (rect1.x + 6 < rect2.data("x") + rect2.data("width") && rect1.x - 1 + rect1.width > rect2.data("x") && rect1.y + 3 < rect2.data("y") + rect2.data("height") && rect1.height + rect1.y > rect2.data("y")) {
				collisionDetected();
			}
		}
		...
		loop = () => {
			...
			if (hardMode) {
				...
				// allows for neverending game with infinite enemies
			}
